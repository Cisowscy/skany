$(document).ready(function() {
  ...
  $("#ZATWIERDZ_WYBOR").click(function(event) {
    $('a[href^="#GAELERIA"]');
    ElTab = $("select#listaSYGNATUR").val();
    $.getJSON("https://cisowscy.github.io/skany/src/bazaSygLink.json", function(
      SygLink
    ) {
      var LinkA =
        "http://" +
        SygLink[ElTab][3] +
        ".home.net.pl/metrykalia/" +
        SygLink[ElTab][2][0] +
        encodeURI("/sygn. " + SygLink[ElTab][2][1]) +
        "/";
...
function loadMapScenario() {
  map = new Microsoft.Maps.Map(document.getElementById("myMap"), {
    credentials:
      "Ag_DhhI4OhAJ28lJwiqxdE65HfSBWC3PT3MY1fYYlLd3vJpYMifcNlFA1-ZrMi7P"
  });
}
